# GameRipper 👾 GitHub Actions Edition - Final Version with Telegram Integration
import requests
import sqlite3
import datetime
...
# ✅ CONFIGURATION (With Your Telegram Token + Chat ID)
...
def notify_status():
    text = "✅ GameRipper 👾 is now active and monitoring free games!"
    notify_telegram(text)
    notify_discord("**✅ GameRipper 👾 is now active and monitoring free games!**")

# SCRAPERS (Epic, GOG, Steam, IndieGala, Reddit)
def scrape_epic():
    try:
